...
const projects = [
  ["bice", "BICE", "Contenido corporativo", "/projects/bice/hero.jpg"],
  ["lolosaurios", "LOLOSAURIOS", "Entretenimiento", "/projects/lolosaurios/hero.jpg"],
  ["futbol-y-parrilla", "FÚTBOL Y PARRILLA", "Deporte · Entretenimiento", "/projects/futbol-y-parrilla/hero.jpg"],
  ["break-industrial", "BREAK INDUSTRIAL", "Industria · Tecnología", "/projects/break-industrial/hero.jpg"],
  ["creando-lideres-para-asia", "CREANDO LÍDERES PARA ASIA", "Contenido internacional", "/projects/creando-lideres-asia/hero.jpg"],
] as const;
  ...
  return (
    <main className="min-h-screen bg-[#050505] px-5 py-24 text-white md:px-10 md:py-32">
      <div className="mb-16 flex items-end justify-between gap-8">
        <div>
          <Link href="/" className="text-[10px] uppercase tracking-[0.25em] text-white/40 hover:text-white">
            ← Dekaelo Media
          </Link>
          ...
          >
            ...
            <div className="mt-5 flex justify-between gap-6">
              <div>
                ...
                <p className="mt-1 text-xs text-white/35">{category}</p>
              </div>
