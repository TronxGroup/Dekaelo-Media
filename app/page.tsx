    ...
    {gallery.map(({ src, alt }, i) => (
      ...
      <section id="contacto" className="scroll-mt-20 py-24 px-6 bg-black">
        ...
        <form action="https://formspree.io/f/mjkepdaj" method="POST" className="max-w-3xl mx-auto bg-gray-900 p-10 rounded-3xl shadow-xl space-y-6 border border-gray-800">
          ...
          <textarea name="mensaje" rows={5} placeholder="Cuéntanos tu objetivo: ventas, posicionamiento, comunicación interna, etc." required className="w-full px-4 py-3 rounded-xl bg-gray-800 text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500" />
          <input type="text" name="_gotcha" className="hidden" aria-hidden={true} tabIndex={-1} />
          <label className="flex items-start gap-2 text-xs text-gray-400">
            <input type="checkbox" name="consent" required className="mt-1" />
            He leído y acepto las <a href="/condiciones" className="underline ml-1">Condiciones</a> y la <a href="/privacidad" className="underline ml-1">Política de Privacidad</a>.
          </label>
