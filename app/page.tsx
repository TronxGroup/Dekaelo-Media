          ...
          <div className="grid gap-12 md:grid-cols-12">
            ...
            <div className="md:col-span-8">
              ...
              <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/35 md:text-lg">
                ...
                Diseñamos el concepto, la estructura, el ritmo y el
                lenguaje audiovisual de cada proyecto, y lo llevamos
                desde la idea hasta la producción y postproducción.
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed text-white/55 md:text-xl">
                ...
                A partir de ella desarrollamos la estructura,
                definimos el ritmo, construimos la dinámica y
                desarrollamos el lenguaje audiovisual que le dará
                identidad al formato.
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-8 max-w-xl text-base leading-relaxed text-white/40 md:text-lg">
            ...
            Cuéntanos tu idea. Podemos ayudarte a convertirla
