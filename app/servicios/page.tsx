          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
            ...
            <div className="relative p-1 rounded-3xl">
              ...
              >
                ...
                <p className="mt-1 text-sm text-gray-400">
                  Para iniciar con presencia mensual
                </p>
                <div className="mt-6">
                ...
                <a
                  href="#contacto"
                  className="mt-auto inline-block w-full text-center px-6 py-3 rounded-xl bg-gray-800 hover:bg-gray-700 transition"
                >
                  Quiero este plan
                </a>
              </div>
            ...
            <div className="relative p-1 rounded-3xl shadow-2xl">
              ...
              >
                ...
                <p className="mt-1 text-sm text-gray-300">
                  Equilibrio perfecto para crecer
                </p>
                <div className="mt-6">
            ...
            <div className="relative p-1 rounded-3xl">
              ...
              >
                ...
                <p className="mt-1 text-sm text-gray-400">
                  Para campañas y mayor cobertura
                </p>
                <div className="mt-6">
            ...
            {[
              {
                ...
                text: 'Mayor cobertura visual para tu proyecto (desde $150.000).',
              },
              {
