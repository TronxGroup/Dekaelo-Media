  ...
  return (
    <main className="bg-black text-white selection:bg-white selection:text-black">
      ...
      <section className="container max-w-4xl pt-28 pb-16 md:pt-36 md:pb-20">
        ...
        <h1 className="mt-4 text-4xl font-semibold leading-[1.1] tracking-tight md:text-5xl">Servicios y precios</h1>
        <p className="mt-6 max-w-2xl text-lg text-white/55 leading-relaxed">Produccion completa en terreno o post-produccion de lo que tu empresa ya grabo. Definimos alcance y plazo el mismo dia.</p>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_380px] lg:items-start">
            <div>
              ...
              <div className="mt-8 rounded-2xl border border-amber-400/15 bg-amber-500/5 p-6">
                ...
                <p className="text-white/70 leading-relaxed"><strong className="text-white">BICECORP</strong> lleva trabajando con nosotros desde 2024 en una serie continua de vodcast institucional. Temporada activa en curso.</p>
              </div>
              <div className="mt-8 grid gap-6 sm:grid-cols-2">
                <div>
                  <p className="text-sm font-semibold text-white mb-4">Que incluye</p>
                  <ul className="space-y-3">
                    {["Diseno de formato y pauta narrativa","Grabacion profesional en tu oficina","Direccion y conduccion tecnica","Edicion completa con color y sonido","Subtitulos y formatos por plataforma","Desde 4 episodios por temporada"].map((item) => (
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {["Vodcast ejecutivo o de liderazgo","Serie institucional para comunicacion interna","Video corporativo para licitacion o presentacion","Programa de contenido continuo para LinkedIn"].map((item) => (
                      <li key={item} className="flex items-start gap-2.5 text-sm text-white/60"><CheckIcon />{item}</li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-7 lg:sticky lg:top-24">
              ...
              <p className="mt-2 text-3xl font-semibold text-white">Desde $650.000 / episodio</p>
              ...
              <p className="mt-4 text-center text-xs text-white/25">Primera conversacion sin costo</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-[1fr_380px] lg:items-start">
            <div>
              ...
              <p className="mt-5 text-lg text-white/55 leading-relaxed">Tu o tu empresa graban. Nosotros editamos y entregamos en el formato correcto para cada plataforma.</p>
              <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-6">
                <p className="text-xs font-semibold uppercase tracking-wider text-white/30 mb-3">Como funciona</p>
                <p className="text-white/70 leading-relaxed"><strong className="text-white">Mandas el material en bruto.</strong> Definimos alcance por escrito antes de empezar, pagas 50% adelantado y en 5 dias habiles recibes el video listo para publicar.</p>
              </div>
              <div className="mt-8 grid gap-6 sm:grid-cols-2">
                <div>
                  <p className="text-sm font-semibold text-white mb-4">Que incluye</p>
                  <ul className="space-y-3">
                    {["Edicion completa del material","Correccion de audio y color","Titulos, creditos y subtitulos","Formato para redes y web","1 ronda de revision incluida","Entrega en 5 dias habiles"].map((item) => (
                      <li key={item} className="flex items-start gap-2.5 text-sm text-white/60"><CheckIcon />{item}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  <p className="text-sm font-semibold text-white mb-4">Casos de uso</p>
                  <ul className="space-y-3">
                    {["Grabacion de evento corporativo","Entrevista a gerente o fundador","Capacitacion interna filmada","Lanzamiento de producto registrado","Testimonio de cliente o caso de exito"].map((item) => (
                      <li key={item} className="flex items-start gap-2.5 text-sm text-white/60"><CheckIcon />{item}</li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-7 lg:sticky lg:top-24">
              ...
              <p className="text-white/35 text-sm">- + IVA - pago unico</p>
        ...
        <div className="container max-w-5xl">
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-white/50 leading-relaxed">Si lo que necesitas no es lo que hacemos, te lo decimos en la primera conversacion.</p>
            </div>
            <ul className="space-y-3 self-center">
              {["Produccion de TV, comerciales o publicidad masiva","Animacion, motion graphics o diseno grafico","Fotografia corporativa o eventos","Gestion de redes sociales","Grabacion sin material previo para post-produccion"].map((item) => (
      ...
      <section className="border-t border-white/10 py-28">
        <div className="container max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-white/50 leading-relaxed">Cuentanos que tienes grabado o que quieres comunicar. Te decimos cual servicio encaja y a que precio.</p>
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a href={buildWa("Consulta general")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white px-10 py-4 text-sm font-semibold text-black transition hover:bg-white/90">
              Escribir por WhatsApp <ArrowUpRight className="h-4 w-4" />
            </a>
