// ✅ FIX: Evitar el error de build
// - Mantener `export const metadata` solo en un **Server Component** (esta página)
// - Mover el formulario Zoho y los handlers a un **Client Component**
// - Incluir reCAPTCHA y scripts de Zoho dentro del Client Component
...
// =========================
// components/ZohoLeadForm.tsx (Client Component)
// =========================
"use client";
...
export default function ZohoLeadForm() {
  return (
    <>
      ...
      {/* Estilos para integrar al theme oscuro */}
      <style
...
#crmWebToEntityForm .g-recaptcha{transform-origin:left top}
        `,
        }}
      />
      ...
      <div className="mt-8 rounded-2xl bg-white/5 border border-white/10 p-6">
        <div id="crmWebToEntityForm" className="zcwf_lblLeft crmWebToEntityForm" style={{ backgroundColor: "transparent", color: "white" }}>
          <form
            ...
            method="POST"
            onSubmit={() => {
              // llama a la validación nativa de Zoho
              // @ts-ignore
          ...
          >
            ...
            <div className="zcwf_row">
              ...
              <div className="zcwf_col_fld"><textarea id="LEADCF3" name="LEADCF3" placeholder="Cuéntanos el objetivo, público y ejemplos de referencia." /></div>
            </div>
            ...
            {/* Funciones de validación Zoho (cliente) */}
