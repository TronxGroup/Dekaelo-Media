      ...
      <div className="container max-w-6xl py-16">
        <div className="grid gap-12 md:grid-cols-[1fr_auto_auto]">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-sm text-white/45 leading-relaxed">
              Estudio audiovisual en Santiago. Vodcast corporativo y video institucional para empresas en Chile.
            </p>
            <p className="mt-4 text-xs text-white/25">Dekaelo Media es parte de Tronx Group.</p>
          </div>

          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/25 mb-4">Contacto</p>
          ...
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/25 mb-4">Sitio</p>
            <Link href="/servicios" className="block text-sm text-white/50 transition hover:text-white">
              Servicios
            </Link>
            <Link href="/portafolio" className="block text-sm text-white/50 transition hover:text-white">
              Portafolio
            </Link>
            <Link href="/quienes-somos" className="block text-sm text-white/50 transition hover:text-white">
              Quienes somos
            </Link>
            <Link href="/contacto" className="block text-sm text-white/50 transition hover:text-white">
              Contacto
            </Link>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/8 pt-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs text-white/25">
            <Link href="/privacidad-condiciones" className="transition hover:text-white">
