      ...
      <div className="container py-10 text-sm grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-white/70">
            Estudio audiovisual en Chile. Ayudamos a marcas y equipos a comunicar
            con claridad y calidad cinematográfica.
          </p>

          {/* ✅ Tronx Group (chico, sin link) */}
        ...
        <div className="md:text-right space-y-2">
          ...
          <p className="text-white/60 mt-2">
            © {new Date().getFullYear()} Dekaelo Media. Todos los derechos
            reservados.
          </p>
